...
/**
 * <p>This caller is loosely based on the legacy ReCapSeg caller that was originally implemented in ReCapSeg v1.4.5.0,
 ...
 * 5) call segments using z-score based on this mean and standard deviation.</p>
 */
